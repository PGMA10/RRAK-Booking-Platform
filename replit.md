...
- **Industry Subcategory System**: Comprehensive subcategory system preventing competing businesses from booking the same route/campaign slot while allowing non-competing specializations. Features 13 industry categories with 56 specific subcategories: Construction (6: Electrical, Carpentry, Plumbing & HVAC, Roofing, Concrete & Masonry, General Contractor), Healthcare (6: Dentist/Orthodontist, Psychiatry/Mental Health, Chiropractic, Optometry, Physical Therapy, Massage Therapy), Financial Services (4: Accounting/Bookkeeping, Financial Planning, Insurance, Tax Services), Real Estate (4: Realtor/Agent, Loan Originator/Mortgage, Property Management, Appraisal Services), Beauty & Wellness (5: Hair Salon, Spa/Massage, Beauty Supply Store, Nail Salon, Aesthetics/Med Spa), Home Services (4: Cleaning Services, Landscaping/Lawn Care, Pest Control, Appliance Repair), Automotive (4: Auto Repair/Mechanic, Auto Detailing, Tire Services, Auto Body/Paint), Food & Beverage (4: Restaurant, Catering, Bakery/Cafe, Bar/Brewery), Professional Services (3: Legal Services, IT Services, Consulting), Retail (5: Clothing/Apparel, Sporting Goods, Electronics, Home Goods, Specialty Retail), Pet Services (4: Veterinary Care, Pet Grooming, Dog Walking/Pet Sitting, Pet Supply Store), Fitness & Recreation (4: Gym/Fitness Center, Personal Training, Yoga/Pilates Studio, Sports Facilities), Outdoor Recreation and Tours (3: Hunting guides, Scenic touring, Fishing charters). Booking form features two-step dropdown (industry → subcategory). Availability checking enforces exclusivity at subcategory level for both pending and paid bookings. UI displays "Industry → Subcategory" badges throughout admin and customer pages. Automatic seeding with smart migration logic that prevents data corruption when bookings exist.
- **"Other" Industry Unlimited Availability**: The "Other" industry category has no subcategories and always shows as available regardless of existing bookings, allowing multiple businesses with different offerings to select it. When selected, customers must provide a mandatory description of their business type for admin review.
